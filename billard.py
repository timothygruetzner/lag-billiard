...
def calc_next_intersection(direction_v):
    ...
    for wall in walls:
        print(wall.last_intersection_coefficient)
        if nearest_wall.last_intersection_coefficient <= 0:
            nearest_wall = wall
        if 0 < wall.last_intersection_coefficient < nearest_wall.last_intersection_coefficient:
            nearest_wall = wall
    ...
    moveBallToNewPoint((intersection[0], intersection[1]))
